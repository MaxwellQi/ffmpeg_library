...
mv x264-snapshot-20150705-2245 x264
...
/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/lipo -create -arch arm64 arm64/lib/libx264.a -arch armv7 armv7/lib/libx264.a -output ./x264-uarch/lib/libx264.a
